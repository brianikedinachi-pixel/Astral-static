...
function _injectEmptyState() {
  ...
  es.innerHTML = `
    ...
    <div class="es-body">
      <img class="es-mark" src="img/icon-512.png" alt="" aria-hidden="true">
      <div class="es-status-badge"><span class="es-status-dot"></span>Ready when you are</div>
      <div class="es-greeting" id="es-greeting">Hey there 👋</div>
      <div class="es-title" id="es-title">
