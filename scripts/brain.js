...
function renderMessages() {
  ...
  displayContainer.innerHTML = htmlResult.map(function(log, idx) {
    ...
    if (log.thinking || (log.aiText !== undefined && log.aiText !== '')) {
      ...
      if (log.thinking) {
        aiPart += '<div class="thinking"><div class="thinking-orbs"><span class="orb"></span><span class="orb"></span><span class="orb"></span><span class="orb"></span><span class="orb"></span></div></div>';
      } else {
        // AI content
