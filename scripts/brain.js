...
async function startConvoMode() {
  ...
  // Multi-party: fresh roster per session, and kick off the speaker tap in
  // the background — non-blocking, and never fatal if it fails (see
  // _startSpeakerTap's own try/catch).
  resetRoster();
  _startSpeakerTap();
