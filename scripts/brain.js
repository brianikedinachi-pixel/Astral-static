  ...
  try {
    ...
    if (data.file_card) {
      ...
      if (_fcBlob) {
        ...
        // Attach card DIRECTLY to the AI message entry instead of creating a new one
        var li_final = htmlResult.length - 1;
        htmlResult[li_final]._fileCard = { fileId: fileId, filename: _fcName, fmt: fc.ext };
